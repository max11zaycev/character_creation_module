"""Игра - симулятор гладиаторской арены."""
...
def start_training(character):
    ...
    #char_class_list = {'warrior':', ты Воитель — великий мастер ближнего боя.',
       # 'mage':', ты Маг — превосходный укротитель стихий.',
      #  'healer':', ты Лекарь — чародей, способный исцелять раны.'
       # }
    print(f'{char_name} {char_class_list[char_class]}')
    ...
    cmd_list ={'attack': char_class.attack,
